...
// END MAIN CONTROLLER DESIGN
  ...
  static Future<Jalali?> showDateTimePicker(BuildContext context,
    ...
    Future<Jalali?> jalaliDate = showPersianDatePicker(
      context: context,
      initialDate: Jalali.fromDateTime(currentTime ?? DateTime.now()),
      firstDate: Jalali.fromDateTime(minTime ?? DateTime.now()),
      lastDate: Jalali.fromDateTime(maxTime ?? DateTime.now()),
