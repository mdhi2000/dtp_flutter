...
class Form_resultAddState extends State {
  ...
  Widget buildRowGlobal_RV_systolic_function() {
    return TextFormField(
      validator: (value) {
        if (value == null || value.isEmpty) {
          return 'Please enter Global_RV_systolic_function';
        }
        return null;
      },
      controller: txtGlobal_RV_systolic_function,
      decoration: InputDecoration(labelText: 'Global_RV_systolic_function'),
    );
  }
  ...
  Widget buildRowDiastolic_function() {
    return TextFormField(
      validator: (value) {
        if (value == null || value.isEmpty) {
          return 'Please enter Diastolic_function';
        }
        return null;
      },
      controller: txtDiastolic_function,
      decoration: InputDecoration(labelText: 'Diastolic_function'),
    );
  }
  ...
  Widget buildRowInteratrial_septum() {
    return TextFormField(
      validator: (value) {
        if (value == null || value.isEmpty) {
          return 'Please enter Interatrial_septum';
        }
        return null;
      },
